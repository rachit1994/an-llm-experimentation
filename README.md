...
why the whole thing runs classically. See [`05-feasibility-verdict.md`](05-feasibility-verdict.md).
...
4. [`02-why-classical-not-a-quantum-computer.md`](02-why-classical-not-a-quantum-computer.md) — why not a QC.
5. [`03-complex-amplitudes-and-the-band.md`](03-complex-amplitudes-and-the-band.md) — "not 0/1, a band," answered honestly.
6. [`04-math-and-mechanisms.md`](04-math-and-mechanisms.md) — the implementable equations, each with its cost term.
7. [`05-feasibility-verdict.md`](05-feasibility-verdict.md) — per-claim PROCEED/KILL and the code greenlight gate.
8. [`06-prototype-plan.md`](06-prototype-plan.md) — the fair bake-off design.
9. [`07-pattern-as-token-the-objective.md`](07-pattern-as-token-the-objective.md) — the deepest leg.
10. [`08-combinatorial-capacity.md`](08-combinatorial-capacity.md) — the capacity math, done right.
11. [`09-hardware-requirements.md`](09-hardware-requirements.md) — everything that fits an M1.
12. [`10-frequency-salience-glow.md`](10-frequency-salience-glow.md) — the glow / confidence layer.
13. [`references.md`](references.md) — annotated bibliography.
14. [`REVIEW-LOG.md`](REVIEW-LOG.md) — five adversarial review passes and what each changed.
...
If you read only two files, read [`GROUND-UP-CONSTRAINTS.md`](GROUND-UP-CONSTRAINTS.md) and
[`05-feasibility-verdict.md`](05-feasibility-verdict.md).
